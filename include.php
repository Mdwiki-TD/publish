...
include_once __DIR__ . '/textfixes/Citation.php';
...
include_once __DIR__ . '/textfixes/md_cat.php';
include_once __DIR__ . '/textfixes/text_fix_refs.php';
include_once __DIR__ . '/textfixes/text_fix.php';
